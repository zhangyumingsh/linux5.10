...
{
	printk(KERN_ERR"falcon rk817_codec rk817_volatile_register -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_volatile_register reg=%u-----------\n",reg);
	switch (reg) {
...
{
	printk(KERN_ERR"falcon rk817_codec rk817_codec_register -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_codec_register reg=%u-----------\n",reg);
	switch (reg) {
...
static int rk817_codec_ctl_gpio(struct rk817_codec_priv *rk817,
				int gpio, int level)
{
	printk(KERN_ERR"falcon rk817_codec rk817_codec_ctl_gpio -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_codec_ctl_gpio gpio=%d level=%d-----------\n",gpio,level);
...
static int rk817_reset(struct snd_soc_component *component)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_reset -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_reset rk817->chip_ver=%d -----------\n",rk817->chip_ver);
...
static int rk817_codec_power_up(struct snd_soc_component *component, int type)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_codec_power_up -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_codec_power_up type=%d -----------\n",type);
	printk(KERN_ERR"falcon rk817_codec rk817_codec_power_up rk817->chip_ver=%d -----------\n",rk817->chip_ver);
...
static int rk817_codec_power_down(struct snd_soc_component *component, int type)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_codec_power_down -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_codec_power_down type=%d -----------\n",type);
				      ...
				      long pre_path, long target_path)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_config -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_config rk817->playback_path=%ld -----------\n",rk817->playback_path);
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_config pre_path=%ld -----------\n",pre_path);
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_config rk817->use_ext_amplifier=%d -----------\n",rk817->use_ext_amplifier);
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_get -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_get rk817->playback_path=%ld -----------\n",rk817->playback_path);
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_put -----------\n");
	...
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_put rk817->playback_path=%ld -----------\n",rk817->playback_path);
	printk(KERN_ERR"falcon rk817_codec rk817_playback_path_put ucontrol->value.integer.value[0]=%ld -----------\n",ucontrol->value.integer.value[0]);
				     ...
				     long pre_path, long target_path)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_config -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_config pre_path=%ld-----------\n",pre_path);
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_config rk817->capture_path=%ld -----------\n",rk817->capture_path);
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_config rk817->mic_in_differential=%d -----------\n",rk817->mic_in_differential);
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_config rk817->adc_for_loopback=%d -----------\n",rk817->adc_for_loopback);
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_get -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_get rk817->capture_path=%ld -----------\n",rk817->capture_path);
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_put -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_put rk817->capture_path=%ld -----------\n",rk817->capture_path);
	printk(KERN_ERR"falcon rk817_codec rk817_capture_path_put ucontrol->value.integer.value[0]=%ld -----------\n",ucontrol->value.integer.value[0]);
				 ...
				 struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_get -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_get rk817->resume_path=%d -----------\n",rk817->resume_path);
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_get ucontrol->value.integer.value[0]=%ld -----------\n",ucontrol->value.integer.value[0]);
				 ...
				 struct snd_ctl_elem_value *ucontrol)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_put -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_put rk817->resume_path=%d -----------\n",rk817->resume_path);
	printk(KERN_ERR"falcon rk817_codec rk817_resume_path_put ucontrol->value.integer.value[0]=%ld -----------\n",ucontrol->value.integer.value[0]);
				...
				int clk_id, unsigned int freq, int dir)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_set_dai_sysclk -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_set_dai_sysclk rk817->stereo_sysclk=%u -----------\n",freq);
	printk(KERN_ERR"falcon rk817_codec rk817_set_dai_sysclk dir=%d -----------\n",dir);
			     ...
			     unsigned int fmt)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_set_dai_fmt -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_set_dai_fmt fmt=%u -----------\n",fmt);
			    ...
			    struct snd_soc_dai *dai)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params rk817->chip_ver=0x%x -----------\n",rk817->chip_ver);	
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params rate=%u -----------\n",rate);	
	...
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params  1 substream->stream=%d -----------\n",substream->stream);
	...
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params  2 substream->stream=%d -----------\n",substream->stream);
	...
	printk(KERN_ERR"falcon rk817_codec rk817_hw_params params_format(params)=%d -----------\n",params_format(params));
...
static int rk817_digital_mute(struct snd_soc_dai *dai, int mute, int stream)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_digital_mute -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_digital_mute mute=%d -----------\n",mute);	
	printk(KERN_ERR"falcon rk817_codec rk817_digital_mute rk817->playback_path=%ld -----------\n",rk817->playback_path);
	...
	if (mute) {
		...
		case SPK_PATH:
		case RING_SPK:
			printk(KERN_ERR"falcon rk817_codec rk817_digital_mute rk817->out_l2spk_r2hp=%d -----------\n",rk817->out_l2spk_r2hp);
			printk(KERN_ERR"falcon rk817_codec rk817_digital_mute rk817->use_ext_amplifier=%d -----------\n",rk817->use_ext_amplifier);
			if (rk817->out_l2spk_r2hp) {
				snd_soc_component_write(component, RK817_CODEC_ADAC_CFG1,
						PWD_DACBIAS_ON | PWD_DACD_ON |
						PWD_DACL_ON | PWD_DACR_ON);
				 ...
				 struct snd_soc_dai *dai)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_codec_shutdown -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_codec_shutdown substream->stream=%d -----------\n",substream->stream);	
...
{
	printk(KERN_ERR"falcon rk817_codec rk817_suspend -----------\n");	
	rk817_codec_power_down(component, RK817_CODEC_ALL);
	return 0;
}
...
static int rk817_resume(struct snd_soc_component *component)
{
	...
	printk(KERN_ERR"falcon rk817_codec rk817_resume -----------\n");
	printk(KERN_ERR"falcon rk817_codec rk817_resume rk817->resume_path=%d -----------\n",rk817->resume_path);	
