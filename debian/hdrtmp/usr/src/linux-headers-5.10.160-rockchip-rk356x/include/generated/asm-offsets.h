...
#define THREAD_SCTLR_USER 3856 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 3752 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3832 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 3848 /* offsetof(struct task_struct, thread.mte_ctrl) */
